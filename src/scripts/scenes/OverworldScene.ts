...
export class OverworldScene extends BaseScene {
	...
	create(): void {
		...
		this.title = this.createText(this.CX, 0.43*this.H, 40, this.weights.bold, "#FA4", "EGGNITE").setOrigin(0.5).setStroke("#732", 6);
		this.title.setPostPipeline(BendWaves2);
		this.title.setVisible(false);

		this.desc = this.createText(this.CX, 0.65*this.H, 18, this.weights.bold, "#FFF").setOrigin(0.5);
